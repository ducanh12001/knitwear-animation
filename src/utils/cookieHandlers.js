...
export const setupGoogleAnalytics = (isAnalyticsAllowed) => {
...
export const setupFunctionalCookies = (isFunctionalAllowed) => {
...
export const setupPerformanceCookies = (isPerformanceAllowed) => {
...
export const setupAdvertisementCookies = (isAdvertisementAllowed) => {
...
export const canLoadScript = (scriptCategory, cookieConsent) => {
