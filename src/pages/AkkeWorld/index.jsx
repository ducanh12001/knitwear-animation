    ...
    <div className="page-akkeworld">
      <section className="relative h-screen w-full">
        <div className="desktop relative h-full w-full">
          <img
            ...
            src="https://akkeknitwear.com/website/wp-content/uploads/2025/03/bannerworld-960x480.webp"
            alt=""
          />
        </div>
      ...
      <ImagesSection
        ...
        blockColumns={{
          ...
          leftImage: "https://akkeknitwear.com/website/wp-content/uploads/2025/03/world-1.webp",
          rightTitle: "Durable and timeless",
          rightImage: "https://akkeknitwear.com/website/wp-content/uploads/2025/03/world-2.webp",
        }}
        blockFull={{
          image: "https://akkeknitwear.com/website/wp-content/uploads/2025/03/banner2-800x400.webp",
      ...
      <section className="akkeworld--image-full relative h-auto w-full">
        <div className="wrapper relative h-auto w-full">
          <div className="image relative z-10 h-auto w-full">
            <img
              src="https://akkeknitwear.com/website/wp-content/uploads/2025/03/full-600x600.webp"
              alt=""
